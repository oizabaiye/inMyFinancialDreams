            ...
            <div className="formRow">
              <label>
                ...
                <input
                  ...
                  value={this.state.housingUtilities}
                  onChange={this.handleChange}
                />
              </label>
            </div>
            <div className="formRow">
              <label htmlFor="phoneInternet">
                Phone & Internet:
                <input
                  type="number"
                  name="phoneInternet"
                  value={this.state.phoneInternet}
                  onChange={this.handleChange}
                />
              </label>
            </div>
            ...
            <div className="formRow">
              <label>
                ...
                <input
                  ...
                  value={this.state.fitnessWellness}
                  onChange={this.handleChange}
                />
              </label>
            </div>
            ...
            <div className="formRow">
              <label>
                ...
                <input
                  type="number"
                  name="beautyGrooming"
                  value={this.state.beautyGrooming}
                  onChange={this.handleChange}
                />
              </label>
            </div>
            ...
            <div className="formRow">
              <label>
                ...
                <input
                  ...
                  value={this.state.savingsInvestment}
                  onChange={this.handleChange}
                />
              </label>
            </div>
            <div className="submit">
              <input type="submit" value="Submit" id="submitButton" disabled={this.state.disabled}/>
            </div>
          </form>
          <Result
